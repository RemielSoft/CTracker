<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Nert.Master" AutoEventWireup="False" CodeBehind="Error.aspx.cs" Inherits="RetirementFunds.Common.Error" %>
                            ...
                            <table cellspacing="0" cellpadding="10" width="50%">
                                <tr> 
                                    ...
                                    <td width="273" valign="top" colspan="2"> 
                                        <div align="left">
                                        <p class="text1">&nbsp;</p>
                                        <p class="text1">NERT Database server is currently down for maintainence. Please try again later or contact us at 1-888-271-8035.
You may also contact us at: <a href="mailto:info@nert.com" ><strong class="text1">info@nert.com</strong></a></p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
