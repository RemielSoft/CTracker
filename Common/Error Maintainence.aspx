                            ...
                            <table cellspacing="0" cellpadding="10" width="50%">
                                <tr> 
                                    ...
                                    <td width="273" valign="top" colspan="2"> 
                                        <div align="left">
                                        <p class="text1">&nbsp;</p>
                                        <p class="text1">Connection attempt unsuccesful. 
Please try again or contact us at: <a href="mailto:info@nert.com" ><strong class="text1">info@nert.com
Please note report server will be undergoing maintainence April 5-6</strong></a></p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
