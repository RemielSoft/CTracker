<%@ Page Language="C#" MasterPageFile="~/MasterPage/Nert.Master" AutoEventWireup="true" CodeBehind="Login4.aspx.cs" Inherits="RetirementFunds.Common.Login4" %>
                        ...
                        <div style="width:98%; padding: 20px 16px 12px 8px;">
                            ...
                            <table width="100%" border="0" cellspacing="4" cellpadding="4">
                                <tr>
                                    ...
                                    <td width="80%"><asp:TextBox ID="txtSSN" runat="server" CssClass="textbox" TextMode="Password" Columns="8" TabIndex="2"></asp:TextBox></td>
                                </tr>
                                <tr>
