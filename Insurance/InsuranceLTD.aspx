<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Nert.Master" AutoEventWireup="true" CodeBehind="InsuranceLTD.aspx.cs" Inherits="RetirementFunds.Insurance.InsuranceLTD" %>
                ...
                <tr>
                    <td>
                        ...
                        <div style="width:98%; padding: 20px 16px 12px 8px;">
                            ...
                            <br />
                            <br />
                            <p class="texth1" style="padding-left:25px;text-align:center;width:50%;">Long Term Disability Insurance Proposal Request</p>
                            ...
                            <table border="0" width="50%" cellpadding="2">
                                ...
                                <tr bgcolor="#E0E0E0"> 
                                    <td width="40%"><font size="-1" face="Arial, Helvetica, sans-serif">Benefit Amount</font></td>
                                    <td width="60%">
                                        <asp:RadioButtonList ID="rblBenefitAmount" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist" TabIndex="21" RepeatColumns="4">
                                            <asp:ListItem Value="1000" Text="$1,000" Selected="True"></asp:ListItem>
                                            ...
                                            <asp:ListItem Value="7500" Text="$7,500"></asp:ListItem>
                                            <asp:ListItem Value="10000" Text="$10,000"></asp:ListItem>                                                                                
                                        </asp:RadioButtonList>                            
                                        <font size="-1" face="Arial, Helvetica, sans-serif"> <b><i>Cannot exceed 75% of income earned</i></b></font>
                                    </td>
                                </tr>
                                <tr bgcolor="#F0F0F0">
                                    <td colspan="2"> 
                                        <table border="0" width="100%">
                                            <tr>
                                                <td><font face="Arial, Helvetica, sans-serif" size="-1">Any Other Coverage? </font></td>
                                                <td style="width:70%" align="left">
                                                    <asp:RadioButtonList ID="rblOtherCover" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist" TabIndex="22">
                                                        <asp:ListItem Value="Yes" Text="YES"></asp:ListItem>
                                                        <asp:ListItem Value="No" Text="NO" Selected="True"></asp:ListItem>
                                                    </asp:RadioButtonList>                                    
                                                </td>
