...
{
    public partial class InsuranceLTD : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            strBdr.Append("<tr>");
            strBdr.Append("<td>OTHER COVERAGE:");
            strBdr.Append("</td>");
            strBdr.Append("<td>&nbsp;" + this.rblOtherCover.SelectedValue.ToString());
            strBdr.Append("</td>");
            strBdr.Append("</tr>");
            ...
            {
                // Send Email
                Utility.SendMail("Long Term Disability Insurance Proposal Request"
                                    , strBdr.ToString()
